# Ground Truth DataHub MCP Tools Discovered

Generated by live `tools/list` RPC round-trip against local DataHub GMS v1.7.0.

## Authentication & Environment Reference
- **DataHub GMS URL**: `http://localhost:8080`
- **PAT Name**: `lineage-marshal-hackathon`
- **PAT Expiry Date**: 2026-11-06 (89 days validity)
- **Setup Architecture**: Self-hosted DataHub OSS via `mcp-server-datahub` (stdio subprocess transport).
- **Mutation Mode**: Enabled (`TOOLS_IS_MUTATION_ENABLED=true`)

## Discovered Tools Summary

Total tools discovered: **18**

| Tool Name | Description | Key Arguments |
| --- | --- | --- |
| `search` | Search across DataHub entities using structured full-text search.     Results are ordered by relevance and importance - ... | `query, filter, num_results, sort_by, sort_order, offset` |
| `get_lineage` | Get upstream or downstream lineage for any entity, including datasets, schemaFields, dashboards, charts, etc.      Set u... | `urn, column, query, filter, upstream, max_hops, max_results, offset` |
| `get_dataset_queries` | Get SQL queries associated with a dataset or column to understand usage patterns.      This tool retrieves actual SQL qu... | `urn, column, source, start, count` |
| `get_entities` | Get detailed information about one or more entities by their DataHub URNs.      IMPORTANT: Pass an array of URNs to retr... | `urns` |
| `list_schema_fields` | List schema fields for a dataset, with optional keyword filtering and pagination.      Useful when schema fields were tr... | `urn, keywords, limit, offset` |
| `get_lineage_paths_between` | Get detailed lineage path(s) between two specific entities or columns.      Returns the paths array from searchAcrossLin... | `source_urn, target_urn, source_column, target_column, direction` |
| `add_tags` | Add one or more tags to multiple DataHub entities or their columns (e.g., schema fields).      This tool allows you to t... | `tag_urns, entity_urns, column_paths` |
| `remove_tags` | Remove one or more tags from multiple DataHub entities or their column_paths (e.g., schema fields).      This tool allow... | `tag_urns, entity_urns, column_paths` |
| `add_terms` | Add one or more glossary terms (terms) to multiple DataHub entities or their columns (e.g., schema fields).      This to... | `term_urns, entity_urns, column_paths` |
| `remove_terms` | Remove one or more glossary terms (terms) from multiple DataHub entities or their column_paths (e.g., schema fields).   ... | `term_urns, entity_urns, column_paths` |
| `add_owners` | Add one or more owners to multiple DataHub entities.      This tool allows you to assign multiple entities with multiple... | `owner_urns, entity_urns, ownership_type` |
| `remove_owners` | Remove one or more owners from multiple DataHub entities.      This tool allows you to unassign multiple entities from m... | `owner_urns, entity_urns, ownership_type` |
| `set_domains` | Set domain for multiple DataHub entities.      This tool allows you to assign a domain to multiple entities in a single ... | `domain_urn, entity_urns` |
| `remove_domains` | Remove domain assignment from multiple DataHub entities.      This tool allows you to unset the domain for multiple enti... | `entity_urns` |
| `update_description` | Update description for a DataHub entity or its column (e.g., schema field).      This tool allows you to set, append to,... | `entity_urn, operation, description, column_path` |
| `add_structured_properties` | Add structured properties with values to multiple DataHub entities.      This tool allows you to assign structured prope... | `property_values, entity_urns` |
| `remove_structured_properties` | Remove structured properties from multiple DataHub entities.      This tool allows you to remove structured property ass... | `property_urns, entity_urns` |
| `save_document` | Save or update a STANDALONE document in DataHub's knowledge base. Once saved,     a document will be visible to all user... | `document_type, title, content, urn, topics, related_documents, related_assets` |
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "keywords": {
          ...
          "default": null,
          "description": "Optional list of keywords to filter schema fields (OR matching).\n     - Single keyword: Treated as one keyword (NOT split on whitespace). Use for field names or exact phrases.\n     - Multiple keywords: Multiple keywords, matches any (OR logic).\n     - None or empty list: Returns all fields in priority order (same as get_entities).\n     Matches against fieldPath, description, label, tags, and glossary terms.\n     Matching fields are returned first, sorted by match count."
        },
        "limit": {
          "default": 100,
          "type": "integer",
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "source_urn": {
          "type": "string",
          "description": "URN of the source dataset"
        },
        "target_urn": {
          "type": "string",
          "description": "URN of the target dataset"
        },
        "source_column": {
          "anyOf": [
            {
          ...
          "default": null,
          "description": "Optional column name in source dataset"
        },
        "target_column": {
          "anyOf": [
            {
          ...
          "default": null,
          "description": "Optional column name in target dataset (required if source_column provided)"
        },
        "direction": {
          "anyOf": [
            {
          ...
          "default": null,
          "description": "Optional direction to search. If None (default), automatically discovers\n      the path by trying downstream first, then upstream. Specify \"downstream\" or\n      \"upstream\" explicitly for better performance if you know the direction."
        }
      },
      "required": [
        "source_urn",
    ...
    "inputSchema": {
      ...
      "properties": {
        "tag_urns": {
          ...
          "type": "array",
          "description": "List of tag URNs to add (e.g., [\"urn:li:tag:PII\", \"urn:li:tag:Sensitive\"])"
        },
        "entity_urns": {
          "items": {
            "type": "string"
          ...
          "type": "array",
          "description": "List of entity URNs to tag (e.g., dataset URNs, dashboard URNs)"
        },
        "column_paths": {
          "anyOf": [
            {
          ...
          "default": null,
          "description": "Optional list of column_path identifiers (e.g., column names for schema fields).\n         Must be same length as entity_urns if provided.\n         Use None or empty string for entity-level tags.\n         For column-level tags, provide the column name (e.g., \"email_address\").\n         Verify that the column_paths are correct and valid via the schemaMetadata.\n         Use get_entity tool to verify."
        }
      },
      "required": [
        "tag_urns",
    ...
    "inputSchema": {
      ...
      "properties": {
        "tag_urns": {
          ...
          "type": "array",
          "description": "List of tag URNs to remove (e.g., [\"urn:li:tag:PII\", \"urn:li:tag:Sensitive\"])"
        },
        "entity_urns": {
          "items": {
            "type": "string"
          ...
          "type": "array",
          "description": "List of entity URNs to untag (e.g., dataset URNs, dashboard URNs)"
        },
        "column_paths": {
          "anyOf": [
            {
    ...
    "inputSchema": {
      ...
      "properties": {
        "term_urns": {
          ...
          "type": "array",
          "description": "List of glossary term URNs to add (e.g., [\"urn:li:glossaryTerm:CustomerData\", \"urn:li:glossaryTerm:SensitiveInfo\"])"
        },
        "entity_urns": {
          "items": {
            "type": "string"
          ...
          "type": "array",
          "description": "List of entity URNs to annotate (e.g., dataset URNs, dashboard URNs)"
        },
        "column_paths": {
          "anyOf": [
            {
    ...
    "inputSchema": {
      ...
      "properties": {
        "term_urns": {
          ...
          "type": "array",
          "description": "List of glossary term URNs to remove (e.g., [\"urn:li:glossaryTerm:Deprecated\", \"urn:li:glossaryTerm:Legacy\"])"
        },
        "entity_urns": {
          "items": {
            "type": "string"
          ...
          "type": "array",
          "description": "List of entity URNs to remove terms from (e.g., dataset URNs, dashboard URNs)"
        },
        "column_paths": {
          "anyOf": [
            {
    ...
    "inputSchema": {
      ...
      "properties": {
        "owner_urns": {
          ...
          "type": "array",
          "description": "List of owner URNs to add (must be CorpUser or CorpGroup URNs).\n       Examples: [\"urn:li:corpuser:john.doe\", \"urn:li:corpGroup:data-engineering\"]"
        },
        "entity_urns": {
          "items": {
            "type": "string"
          ...
          "type": "array",
          "description": "List of entity URNs to assign ownership to (e.g., dataset URNs, dashboard URNs)"
        },
        "ownership_type": {
          "anyOf": [
            {
              "description": "Built-in ownership types in DataHub.",
              "enum": [
                "__system__technical_owner",
                "__system__business_owner",
                "__system__data_steward"
              ],
              "type": "string"
            },
            {
          ...
          "description": "The type of ownership to assign. Accepts either:\n           - A built-in OwnershipType enum value:\n             - TECHNICAL_OWNER: Involved in production, maintenance, or distribution\n             - BUSINESS_OWNER: Principle stakeholders or domain experts\n             - DATA_STEWARD: Involved in governance\n           - A custom ownership type, passed by its user-facing name\n             (e.g. \"Producer\"). Custom types are looked up by name\n             (case-insensitive) via GraphQL and must already exist."
        }
      },
      "required": [
        "owner_urns",
    ...
    "inputSchema": {
      ...
      "properties": {
        "owner_urns": {
          ...
          "type": "array",
          "description": "List of owner URNs to remove (must be CorpUser or CorpGroup URNs).\n       Examples: [\"urn:li:corpuser:john.doe\", \"urn:li:corpGroup:data-engineering\"]"
        },
        "entity_urns": {
          "items": {
            "type": "string"
          ...
          "type": "array",
          "description": "List of entity URNs to remove ownership from (e.g., dataset URNs, dashboard URNs)"
        },
        "ownership_type": {
          "anyOf": [
            {
          ...
          "default": null,
          "description": "Optional ownership type to specify which type of ownership to remove.\n           If not provided, will remove ownership regardless of type.\n           Accepts either a built-in OwnershipType enum value\n           (TECHNICAL_OWNER, BUSINESS_OWNER, DATA_STEWARD) or a custom ownership\n           type by its user-facing name (e.g. \"Producer\"). Custom types are looked\n           up by name (case-insensitive) and must already exist in DataHub."
        }
      },
      "required": [
        "owner_urns",
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "entity_urns": {
          ...
          "type": "array",
          "description": "List of entity URNs to assign to the domain (e.g., dataset URNs, dashboard URNs)"
        }
      },
      "required": [
        "domain_urn",
    ...
    "inputSchema": {
      ...
      "properties": {
        "entity_urns": {
          ...
          "type": "array",
          "description": "List of entity URNs to remove domain from (e.g., dataset URNs, dashboard URNs)"
        }
      },
      "required": [
        "entity_urns"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "column_path": {
          ...
          "default": null,
          "description": "Column_path identifier (e.g., column name for schema field).\n        Optional for all entity types (use None for entity-level descriptions).\n        For column-level descriptions, provide the column name (e.g., \"customer_email\").\n        Verify that the column_path is correct and valid via the schemaMetadata.\n        Use get_entity tool to verify."
        }
      },
      "required": [
        "entity_urn"
    ...
    "inputSchema": {
      ...
      "properties": {
        "property_values": {
          ...
          "type": "object",
          "description": "Dictionary mapping structured property URNs to lists of values.\n            Example: {\n                \"urn:li:structuredProperty:io.acryl.privacy.retentionTime\": [\"90\"],\n                \"urn:li:structuredProperty:io.acryl.common.businessCriticality\": [\"HIGH\"]\n            }"
        },
        "entity_urns": {
          "items": {
            "type": "string"
          ...
          "type": "array",
          "description": "List of entity URNs to assign properties to (e.g., dataset URNs, dashboard URNs)"
        }
      },
      "required": [
        "property_values",
    ...
    "inputSchema": {
      ...
      "properties": {
        "property_urns": {
          ...
          "type": "array",
          "description": "List of structured property URNs to remove\n          Example: [\"urn:li:structuredProperty:io.acryl.privacy.retentionTime\"]"
        },
        "entity_urns": {
          "items": {
            "type": "string"
          ...
          "type": "array",
          "description": "List of entity URNs to remove properties from (e.g., dataset URNs, dashboard URNs)"
        }
      },
      "required": [
        "property_urns",
